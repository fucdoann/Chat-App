...
<body>
	<div class="container">
		<br />
        <h3 class="text-center">Welcome to HustChat - Now you can connect with every one</h3>
        <br />
		<div class="row">
					...
					<div class="card-header">
						<div class="row">
							...
							<div class="col col-sm-6 text-right">
								...
								<a href="groupchat.php" class="btn btn-info btn-sm">Group Chat</a>
							</div>
						</div>
					</div>
			...
			<div class="col-lg-4">
				...
				<div class="mt-3 mb3 text-center">
				<input type="button" class="btn btn-success" id="showMember" value="Member">
