...
if(isset($_POST["register"]))
{
    ...
    else
    {
        if($user_object->save_data())
        {
            ...
            $mail->Username   = 'phucdinhmontage@gmail.com';                     // SMTP username
            $mail->Password   = 'zwikaiwtddhgetky';

            $mail->SMTPSecure = 'ssl';

            $mail->Port = 465;

            $mail->setFrom('phuc.dd200470@sis.hust.edu.vn', 'Doan Dinh Phuc');
            ...
            $mail->Body = '
            <p>Welcome to HustChat.</p>
                <p>This is a verification email, please click the link to verify your email address.</p>
                <p><a href="http://localhost:3000/ProjectI/verify.php?code='.$user_object->getUserVerificationCode().'">Click to Verify</a></p>
                <p>Thank you...</p>
            ';
